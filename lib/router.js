...
privateRoutes.route('/postlist/:_id', {
	name: 'postpage',
	subscriptions: function(params, queryParams) {
		var _id = params;
		Meteor.subscribe('singlePost', _id);
	},
	action: function () {
		BlazeLayout.render('layout', {top : 'header', left : 'sidebar', content: 'postPage', controls : 'controles'});
	}
});
...
privateRoutes.route('/blindlist/:_id', {
	name: 'blindpage', // postpage.html 과 같이.
	subscriptions: function(params, queryParams) {
		var _id = params;
		Meteor.subscribe('singleBlind', _id);
	},
	action: function () {
		BlazeLayout.render('layout', {top : 'header', left : 'sidebar', content: 'blindpage', controls : 'controles'});
	}
});
privateRoutes.route('/google_api', {
	name: 'google_api',
	subscriptions: function(params, queryParams) {
		this.register('userAll', Meteor.subscribe('userAll'));
    },
	action: function () {
...
privateRoutes.route('/api/:userName', {
	subscriptions: function(params, queryParams) {
		var json = {};
		console.log(params);
		console.log(queryParams);
