...
Template.blindEditModal.onCreated(function() {
    const self          = this;
...
Template.blindEditModal.helpers({
...
Template.blindEditModal.events({
    ...
    'click #update' : function (e, t) {
        ...
        var currentblindId = this._id;
        Blinds.update(currentblindId, {$set: blind}, function(error) {
          if (error) {
            // display the error to the user
            return Bert.alert(error.reason);
          } else {
            Modal.hide('blindEditModal');
